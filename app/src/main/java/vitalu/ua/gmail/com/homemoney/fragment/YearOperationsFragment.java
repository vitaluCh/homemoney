 ...
 */
public class  YearOperationsFragment extends TimeOfPeriodOperations/*ListFragment*/ {
    @Override
    public List<Operation> getOperations() {
        return OperationQuery.getListYear(position, idOperation);
    }

/*    private static final String CREATE_LIST_YEAR = "vitalu.ua.gmail.com.homemoney.fragment.create_list";
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        final int position = getArguments().getInt(CREATE_LIST_YEAR);
        ...
        mOperations.addAll(OperationQuery.getListYear(position, idOperation));
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        intent.putExtra(OperationActivity.EXTRA_PERIOD_OPERATION, OperationActivity.YEAR_OPERATION);//период день, месяц,...
    ...
    public static YearOperationsFragment newInstance(int position, int idOperation) {//позиция в списке
        Bundle args = new Bundle();
        args.putInt(CREATE_LIST_YEAR, position);
        args.putInt(EXTRA_OPERATION, idOperation);
        YearOperationsFragment fragment = new YearOperationsFragment();
