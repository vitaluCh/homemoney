...
import vitalu.ua.gmail.com.homemoney.fragment.ExpandListSourceFragment;
import vitalu.ua.gmail.com.homemoney.model.database_model.Source;

public class SourceActivity extends SingleFragmentActivity implements CreateSourceDialog.AddingSourceListener{
    ...
    public void onClick(View v) {
        DialogFragment addingTaskDialogFragment = CreateSourceDialog
                .newInstance(CreateCurrencyDialog.CREATE_SOURCE_ACTIVITY, operation);
