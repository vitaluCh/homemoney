 ...
 */
public class MonthOperationsFragment extends TimeOfPeriodOperations/*ListFragment*/ {
    @Override
    public List<Operation> getOperations() {
        return OperationQuery.getListMonth(position, idOperation);
    }

/*    private static final String CREATE_LIST_MONTH = "vitalu.ua.gmail.com.homemoney.fragment.create_list";
    ...
    public MonthOperationsFragment() {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        final int position = getArguments().getInt(CREATE_LIST_MONTH);
        ...
        mOperations.addAll(OperationQuery.getListMonth(position, idOperation));
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        intent.putExtra(OperationActivity.EXTRA_PERIOD_OPERATION, OperationActivity.MONTH_OPERATION);//период день, месяц,...
    ...
    public static MonthOperationsFragment newInstance(int position, int idOperation) {//позиция в списке
        Bundle args = new Bundle();
        args.putInt(CREATE_LIST_MONTH, position);
        args.putInt(EXTRA_OPERATION, idOperation);
        MonthOperationsFragment fragment = new MonthOperationsFragment();
