 ...
 */
public class SourceExpandableListAdapter extends BaseExpandableListAdapter {

    public static final String TAG = "myLogMainActivity";

    private Context mContext;
    private ArrayList<Map<String, Source>> parentData;
    private ArrayList<ArrayList<Map<String, Source>>> childData;

    private OnChoiceSourceListener choiceSourceListener;

    public interface OnChoiceSourceListener{
        void choiceSource(Source source, int position);
    }

    public SourceExpandableListAdapter (Context context, ArrayList<Map<String, Source>> parentData,
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        textGroup.setText(parentData.get(groupPosition).get(SourceQuery.GROUP_NAME).getNameSours());
            ...
            public void onClick(View v) {
               /* Toast.makeText(mContext, parentData.get(groupPosition)
                ...
                choiceSourceListener.choiceSource(parentData.get(groupPosition)
                        .get(SourceQuery.GROUP_NAME), groupPosition);
            }
        });
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        textChild.setText(childData.get(groupPosition).get(childPosition).get(SourceQuery.CHILD_NAME).getNameSours());

/*        textChild.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
            *//*    Toast.makeText(mContext, childData.get(groupPosition)
                        .get(childPosition).get(SourceQuery.CHILD_NAME).getNameSours(),
                        Toast.LENGTH_SHORT).show();*//*

                choiceSourceListener.choiceSource(childData.get(groupPosition)
                        .get(childPosition).get(SourceQuery.CHILD_NAME));
            }
        });*/
